...
P1A.cpp - List
This file works with the header to define the functions named in the header. It 
gives the user the ability to make a list, add items to the list, read the list,
and check different variables associated with the list.
*/
...
the value of listCapacity and tell the computer that there's nothing in the list
...
/*Bella
this returns a value that's either true or false based on the availability in 
...
specific text. if the text is found awesome it returns the index it was found at
...
/*Bella
this tells us what the value is at the given index. if you forget whats in the 
