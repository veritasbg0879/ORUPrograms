...
P1A.cpp - List
This file works with the header to define the functions named in the header. It gives the user the ability to make a list, add items to the list, read the list, and check different variables associated with the list.
*/
